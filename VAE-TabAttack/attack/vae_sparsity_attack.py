...
class VAESparsityAttack:
    def __init__(self, 
                 ...
                 max_iter: int = 1000,
                 kappa: float = 0.0,
                 gamma: float = 0.1,  # Sigmoid threshold parameter
        ...
        self._gamma = gamma  # Threshold for sparsity loss

        self.vae = vae_model
        self.device = device
        self._batch_size = batch_size
        self._attack = "sparsity"  # Updated attack name

    def _compute_sparsity_loss(self, original_instance, adv_example):
        """
        Compute sparsity loss using thresholded L0 norm calculation.
